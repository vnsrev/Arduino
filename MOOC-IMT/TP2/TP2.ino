...
void setup() {
        ...
        pinMode(biGreen, OUTPUT); // indique que la broche de la LED verte du feu bicolore est une sortie.
        pinMode(biRed, OUTPUT); // indique que la broche de la LED rouge du feu bicolore est une sortie.
